...
class IntegrationTest < ActionController::IntegrationTest
  ...
  test "use case scenario" do
	...
	fill_in 'Invite code', :with => '12345'
	...
	1.upto(10) { |i|
		...
		select "Category #{i%2==0?1:2}", :from => 'Category'
		click_button 'Create'
		page.has_content? 'Article was successfully created'
		click_link 'Back'
	}
